...
describe('API Service', () => {
  ...
  it('fetchAllLeagues should fetch and return leagues data', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('https://www.thesportsdb.com/api/v1/json/3/all_leagues.php')
  ...
  it('fetchLeagueBadge should fetch and return a badge URL if seasons exist', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('https://www.thesportsdb.com/api/v1/json/3/search_all_seasons.php?badge=1&id=123')
